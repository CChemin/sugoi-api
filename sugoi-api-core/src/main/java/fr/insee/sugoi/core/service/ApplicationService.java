...
public interface ApplicationService {
  ...
  PageResult<Application> findByProperties(String realm, Map<String, String> properties);

  PageResult<Application> findByProperties(
      String realm, Map<String, String> properties, String storage);

  PageResult<Application> findAll(String realm);

  PageResult<Application> findAll(String realm, String Storage);
}
